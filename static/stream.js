...
class ViewerApp {
    ...
    startStream(hostId, appId, settings, browserSize) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Set video
            if (!((_a = this.settings) === null || _a === void 0 ? void 0 : _a.canvasRenderer)) {
    ...
    getStreamRect() {
        ...
        if (!((_c = this.settings) === null || _c === void 0 ? void 0 : _c.canvasRenderer)) {
    ...
    getElement() {
        var _a;
        return !((_a = this.settings) === null || _a === void 0 ? void 0 : _a.canvasRenderer) ? this.videoElement : this.canvasElement;
    }
    getStream() {
        return this.stream;
    }
